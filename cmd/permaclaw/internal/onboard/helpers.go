...
func onboard(encrypt bool) {
	...
	fmt.Printf("\n%s permaclaw is ready!\n", internal.Logo)
	fmt.Println("\nNext steps:")
	if encrypt {
		fmt.Println("  1. Set your encryption passphrase before starting permaclaw:")
		fmt.Println("       export PERMACLAW_KEY_PASSPHRASE=<your-passphrase>   # Linux/macOS")
		fmt.Println("       set PERMACLAW_KEY_PASSPHRASE=<your-passphrase>      # Windows cmd")
		fmt.Println("")
	...
	fmt.Println("")
	fmt.Println("  3. Chat: permaclaw agent -m \"Hello!\"")
}
...
// setupSSHKey generates the permaclaw-specific SSH key at ~/.ssh/permaclaw_ed25519.key.
