...
Examples:
  permaclaw model                    # Show current default model
  permaclaw model gpt-5.2           # Set gpt-5.2 as default
  permaclaw model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  permaclaw model local-model       # Set local VLLM server as default
