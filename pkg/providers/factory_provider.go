...
import (
	...
	anthropicmessages "github.com/aostore-ar/permaclaw/pkg/providers/anthropic_messages"
	"github.com/aostore-ar/permaclaw/pkg/providers/azure"
)
...
func createClaudeAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for anthropic. Run: permaclaw auth login --provider anthropic")
	}
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: permaclaw auth login --provider openai")
	}
