...
import (
	...
	anthropicprovider "github.com/aostore-ar/permaclaw/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: permaclaw auth login --provider anthropic")
		}
