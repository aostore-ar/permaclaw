...
// DefaultConfig returns the default configuration for PermaClaw.
func DefaultConfig() *Config {
	// Determine the base path for the workspace.
	// Priority: $PERMACLAW_HOME > ~/.permaclaw
	var homePath string
	if permaclawHome := os.Getenv("PERMACLAW_HOME"); permaclawHome != "" {
		homePath = permaclawHome
	} else {
		userHome, _ := os.UserHomeDir()
		homePath = filepath.Join(userHome, ".permaclaw")
	}
	...
	return &Config{
		...
		Tools: ToolsConfig{
			...
			Skills: SkillsToolsConfig{
				...
				Registries: SkillsRegistriesConfig{
					...
					AoStore: AoStoreRegistryConfig{
						Enabled: false,
						ProcessID: "",
						AONodeURL: "https://ao.arweave.net",
					},
				},
		...
		// New PermaClaw fields
		WalletPath:   "",
		MainProcessID: "",
		AoStore: AoStoreConfig{
			Enabled:   false,
			ProcessID: "",
			AONodeURL: "https://ao.arweave.net",
		},
		...
		Biocompute: BiocomputeConfig{
			Enabled:   false,
			ProcessID: "",
			CL1Endpoint: "http://localhost:8080",
		},
	}
}