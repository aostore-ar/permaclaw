#!/bin/sh
# Starts a local Ergo IRC server for testing the IRC channel in PermaClaw.
#
# Requirements: docker
...
CONTAINER_NAME="permaclaw-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.permaclaw/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run PermaClaw:"
echo "  permaclaw gateway"
echo ""
...
echo "  Join #test, then: permabot: hello"
echo ""
