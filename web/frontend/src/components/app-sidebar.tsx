...
const baseNavGroups: Omit<NavGroup, "items">[] = [
  ...
  { label: "navigation.models", defaultOpen: true },
  { label: "navigation.agent", defaultOpen: true },
  { label: "store", defaultOpen: true },           // aoStore group
  { label: "permanent", defaultOpen: true },       // PermaClaw core group
